...
<head>
  ...
  <link href="http://localhost/PWeb_UTS/assets/css/bootstrap.min.css" rel="stylesheet">
  <script src="http://localhost/PWeb_UTS/assets/js/bootstrap.bundle.min.js"></script>
  <script src="http://localhost/PWeb_UTS/assets/js/jquery.min.js"></script>
  <script src="http://localhost/PWeb_UTS/assets/js/dataTables.js"></script>
  <script src="http://localhost/PWeb_UTS/assets/js/dataTables.bootstrap5.js"></script>
</head>
<body>
...
<nav class="navbar navbar-expand-sm bg-success navbar-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="http://localhost/PWeb_UTS/assets/img/download.png" style="width:40px;" class="rounded-pill"> 
    </a>
